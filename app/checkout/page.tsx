    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <Card className="max-w-md mx-auto mb-6">
        ...
        <CardContent>
            ...
            {items.map((item) => (
              <li key={item.id} className="flex flex-col gap-2 border-b pb-2">
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">{((item.price * item.quantity)).toLocaleString('en-US')} RWF</span>
                </div>
          ...
          <div className="mt-4 border-t pt-2 text-xl font-bold text-center">Total: {(total ).toLocaleString('en-US')} RWF</div>
        </CardContent>
      </Card>
